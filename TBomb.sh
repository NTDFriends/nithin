...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        ...
        toilet -f mono12 -F border NTD Friends
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           Telegram: https://t.me/TBombChat \e[0m"
    echo -e "\e[4;32m   Website: http://nithinnithumn.unaux.com/ \e[0m"
    echo " "
...
do
    ...
    echo "Press 3 To  Start MAIL Bomber (It is not Working)"
